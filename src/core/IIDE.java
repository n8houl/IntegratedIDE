...
public class IIDE extends JFrame {
	...
	public IIDE(String workspaceDir) {
		try {
		...
		IIDE.workspaceDir = workspaceDir;
		System.out.println(IIDE.workspaceDir);
		try {
		...
		cut.setIcon(new ImageIcon(IIDE.class.getResource("images/cut.gif")));

		cop.setText(null);
		cop.setToolTipText("Copy");
		cop.setIcon(new ImageIcon(IIDE.class.getResource("images/open.gif")));

		pas.setText(null);
		pas.setToolTipText("Paste");
		pas.setIcon(new ImageIcon(IIDE.class.getResource("images/paste.gif")));
